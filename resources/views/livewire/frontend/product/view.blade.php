                                        ...
                                        <div class="product-card-body">
                                            ...
                                            <div>
                                                @if ($relatedProductItem->selling_price == $relatedProductItem->original_price)
                                                    <span class="selling-price">Rp
                                                        {{ number_format($relatedProductItem->selling_price, 0, ',', '.') }}</span>
                                                @else
                                                    <span class="selling-price">Rp
                                                        {{ number_format($relatedProductItem->selling_price, 0, ',', '.') }}</span>
                                                    <span class="original-price">Rp
                                                        {{ number_format($relatedProductItem->original_price, 0, ',', '.') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(function() {
            $("#exzoom").exzoom({
                ...
                "enableZoom": false, // Menonaktifkan fitur zoom
                "zoomWidth": 0, // Mengatur lebar zoom ke 0
                "zoomHeight": 0
            });
