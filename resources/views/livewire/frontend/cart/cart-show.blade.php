                                    ...
                                    <div class="row">
                                                ...
                                                <label class="product-name">
                                                    ...
                                                    @if ($cartItem->productColor)
                                                        @if ($cartItem->productColor->color)
                                                            <span>{{ $cartItem->productColor->color->name }}</span>
                                                        @endif
                                                    @endif
                                        ...
                                        <div class="col-md-2 my-auto">
                                            <label class="price">Rp
                                                {{ number_format($cartItem->product->selling_price, 0, ',', '.') }}</label>
                                        </div>
                                        ...
                                        <div class="col-md-2 my-auto">
                                            <label class="price">Rp
                                                {{ number_format($cartItem->product->selling_price * $cartItem->quantity, 0, ',', '.') }}</label>
                                                @php
                                                    $totalPrice = $totalPrice + $cartItem->product->selling_price * $cartItem->quantity 
                                                @endphp
                                        </div>
